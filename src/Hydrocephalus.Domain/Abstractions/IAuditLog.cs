...
public enum AuditEventCode
{
    ...
    /// <summary>
    /// Отчёт показан на экране предпросмотра.
    ///
    /// Отдельный код, а не разновидность экспорта: файл никуда не ушёл.
    /// Но клинический вариант содержит идентификаторы пациента, и показ его
    /// на экране — раскрытие. Раскрытие без следа в журнале ничем не отличается
    /// от того, которого не было.
    /// </summary>
    ReportPreviewed = 13,
}
