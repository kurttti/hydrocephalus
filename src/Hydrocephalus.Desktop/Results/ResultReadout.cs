...
/// а не опускаются: «InconsistentGeometry» ничего не говорит врачу, а «шаг срезов
/// 5 мм при отклонении до 3,2 мм» говорит, и по этому уже можно действовать.
///
        ...
        if (biomarkers.Count == 0)
        {
            ...
            [
                new ResultRow
                {
                    ...
                    Note = "Серия: уровень получения — " + NameOf(series.Tier)
                        + ", взвешенность — " + NameOf(series.Weighting) + ".",
