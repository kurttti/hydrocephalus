...
def test_a_flat_roof_gives_a_straight_angle_and_no_vertex() -> None:
    # Плоская крыша — вырожденный случай: угол определён и равен 180, а точки
    # пересечения у параллельных прямых нет. Отказ здесь был бы неверен — так
    # выглядят очень широкие желудочки, а не негодное измерение.
